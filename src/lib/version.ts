...
export const APP_RELEASE_DATE = '2026-09-09';
...
export const APP_DISCLAIMER = 'OpenBon v0.4.25 - Nutzung auf eigene Verantwortung ohne Gewähr.';
export const GITHUB_REPO_URL = 'https://github.com/loe17/OpenBon';
export const APP_HOMEPAGE = 'https://openbon.org';
export const APP_CODENAME = 'OpenBon Release v0.4.25';
